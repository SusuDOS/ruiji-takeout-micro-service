package com.szl.reggie.validator.config;
...
public class ValidatorConfiguration {
    ...
    /*
     * @Bean
     * public FormValidatorController
     * getFormValidatorController(RequestMappingHandlerMapping
     * requestMappingHandlerMapping) {
     * return new FormValidatorController(constraintExtract(),
     * requestMappingHandlerMapping);
     * }
     */
}