package com.szl.reggie.user.config;

import java.util.List;
import com.szl.reggie.user.feign.UserResolveApi;
import com.szl.reggie.user.interceptor.ContextHandlerInterceptor;
import com.szl.reggie.user.resolver.ContextArgumentResolver;
