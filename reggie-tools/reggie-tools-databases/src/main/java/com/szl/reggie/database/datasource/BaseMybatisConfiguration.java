package com.szl.reggie.database.datasource;
...
import com.szl.reggie.base.id.IdGenerate;
import com.szl.reggie.base.id.SnowflakeIdGenerate;
import com.szl.reggie.database.mybatis.typehandler.FullLikeTypeHandler;
import com.szl.reggie.database.mybatis.typehandler.LeftLikeTypeHandler;
import com.szl.reggie.database.mybatis.typehandler.RightLikeTypeHandler;
import com.szl.reggie.database.parsers.TenantWebMvcConfigurer;
...
public abstract class BaseMybatisConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(name = "reggie.database.isMultiTenant", havingValue = "true", matchIfMissing = true)
