package com.szl.reggie.database.properties;
...
import static com.szl.reggie.database.properties.DatabaseProperties.PREFIX;
/**
 * 客户端认证配置
 */
...
public class DatabaseProperties {
    public static final String PREFIX = "reggie.database";
    /**
     * 攻击 SQL 阻断解析器
     */
     ...
     * 事务扫描基础包
     */
    private String transactionScanPackage = "com.szl.reggie";
}
